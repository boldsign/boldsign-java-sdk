...
public class TemplateGroupSigner {
  ...
  public TemplateGroupSigner signerEmail(String signerEmail) {
  ...
  public TemplateGroupSigner signerName(String signerName) {
  ...
  public boolean equals(Object o) {
    ...
    TemplateGroupSigner templateGroupSigner = (TemplateGroupSigner) o;
    return Objects.equals(this.signerEmail, templateGroupSigner.signerEmail) &&
        Objects.equals(this.signerName, templateGroupSigner.signerName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateGroupSigner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateGroupSigner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateGroupSigner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateGroupSigner is not found in the empty JSON string", TemplateGroupSigner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateGroupSigner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateGroupSigner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateGroupSigner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateGroupSigner.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateGroupSigner>() {
           @Override
           public void write(JsonWriter out, TemplateGroupSigner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateGroupSigner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateGroupSigner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateGroupSigner
   * @throws IOException if the JSON string is invalid with respect to TemplateGroupSigner
   */
  public static TemplateGroupSigner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateGroupSigner.class);
  }

  /**
   * Convert an instance of TemplateGroupSigner to an JSON string
   *
   * @return JSON string
   */
