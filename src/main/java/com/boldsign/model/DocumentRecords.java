...
public class DocumentRecords {
  ...
  public boolean equals(Object o) {
    ...
    DocumentRecords documentRecords = (DocumentRecords) o;
    return Objects.equals(this.pageDetails, documentRecords.pageDetails) &&
        Objects.equals(this.result, documentRecords.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentRecords {\n");
  ...
  public Map<String, Object> createFormData() throws ApiException {
    ...
    if(!fileTypeFound) {
        Field[] fields = DocumentRecords.class.getDeclaredFields();
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentRecords
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentRecords.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentRecords is not found in the empty JSON string", DocumentRecords.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentRecords.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentRecords' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentRecords> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentRecords.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentRecords>() {
           @Override
           public void write(JsonWriter out, DocumentRecords value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DocumentRecords read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentRecords given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentRecords
   * @throws IOException if the JSON string is invalid with respect to DocumentRecords
   */
  public static DocumentRecords fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentRecords.class);
  }

  /**
   * Convert an instance of DocumentRecords to an JSON string
   *
   * @return JSON string
   */
