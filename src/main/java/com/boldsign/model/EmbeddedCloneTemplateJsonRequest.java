...
public class EmbeddedCloneTemplateJsonRequest {
  ...
  public static final String SERIALIZED_NAME_INCLUDE_FORM_FIELD_VALUES = "includeFormFieldValues";
  @SerializedName(SERIALIZED_NAME_INCLUDE_FORM_FIELD_VALUES)
  private Boolean includeFormFieldValues = false;
  ...
  public EmbeddedCloneTemplateJsonRequest() {
  }

  public EmbeddedCloneTemplateJsonRequest redirectUrl(URI redirectUrl) {
  ...
  public EmbeddedCloneTemplateJsonRequest viewOption(ViewOptionEnum viewOption) {
  ...
  public EmbeddedCloneTemplateJsonRequest showSaveButton(Boolean showSaveButton) {
  ...
  public EmbeddedCloneTemplateJsonRequest showPreviewButton(Boolean showPreviewButton) {
  ...
  public EmbeddedCloneTemplateJsonRequest showNavigationButtons(Boolean showNavigationButtons) {
  ...
  public EmbeddedCloneTemplateJsonRequest linkValidTill(OffsetDateTime linkValidTill) {
  ...
  public EmbeddedCloneTemplateJsonRequest includeFormFieldValues(Boolean includeFormFieldValues) {
    this.includeFormFieldValues = includeFormFieldValues;
    return this;
  }

  /**
   * Get includeFormFieldValues
   * @return includeFormFieldValues
   */
  @javax.annotation.Nullable
  public Boolean getIncludeFormFieldValues() {
    return includeFormFieldValues;
  }

  public void setIncludeFormFieldValues(Boolean includeFormFieldValues) {
    this.includeFormFieldValues = includeFormFieldValues;
  }


  public EmbeddedCloneTemplateJsonRequest locale(LocaleEnum locale) {
    this.locale = locale;
    return this;
  }
  ...
  public EmbeddedCloneTemplateJsonRequest showCreateButton(Boolean showCreateButton) {
  ...
  public EmbeddedCloneTemplateJsonRequest showToolbar(Boolean showToolbar) {
  ...
  public EmbeddedCloneTemplateJsonRequest showTooltip(Boolean showTooltip) {
  ...
  public EmbeddedCloneTemplateJsonRequest onBehalfOf(String onBehalfOf) {
  ...
  public boolean equals(Object o) {
    ...
    EmbeddedCloneTemplateJsonRequest embeddedCloneTemplateJsonRequest = (EmbeddedCloneTemplateJsonRequest) o;
    return Objects.equals(this.redirectUrl, embeddedCloneTemplateJsonRequest.redirectUrl) &&
        Objects.equals(this.viewOption, embeddedCloneTemplateJsonRequest.viewOption) &&
        Objects.equals(this.showSaveButton, embeddedCloneTemplateJsonRequest.showSaveButton) &&
        Objects.equals(this.showPreviewButton, embeddedCloneTemplateJsonRequest.showPreviewButton) &&
        Objects.equals(this.showNavigationButtons, embeddedCloneTemplateJsonRequest.showNavigationButtons) &&
        Objects.equals(this.linkValidTill, embeddedCloneTemplateJsonRequest.linkValidTill) &&
        Objects.equals(this.includeFormFieldValues, embeddedCloneTemplateJsonRequest.includeFormFieldValues) &&
        Objects.equals(this.locale, embeddedCloneTemplateJsonRequest.locale) &&
        Objects.equals(this.showCreateButton, embeddedCloneTemplateJsonRequest.showCreateButton) &&
        Objects.equals(this.showToolbar, embeddedCloneTemplateJsonRequest.showToolbar) &&
        Objects.equals(this.showTooltip, embeddedCloneTemplateJsonRequest.showTooltip) &&
        Objects.equals(this.onBehalfOf, embeddedCloneTemplateJsonRequest.onBehalfOf);
  }

  @Override
  public int hashCode() {
    return Objects.hash(redirectUrl, viewOption, showSaveButton, showPreviewButton, showNavigationButtons, linkValidTill, includeFormFieldValues, locale, showCreateButton, showToolbar, showTooltip, onBehalfOf);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmbeddedCloneTemplateJsonRequest {\n");
    ...
    sb.append("    includeFormFieldValues: ").append(toIndentedString(includeFormFieldValues)).append("\n");
  ...
  public Map<String, Object> createFormData() throws ApiException {
    ...
    if (includeFormFieldValues != null) {
        if (isFileTypeOrListOfFiles(includeFormFieldValues)) {
            fileTypeFound = true;
        }

        if (includeFormFieldValues.getClass().equals(java.io.File.class) ||
            includeFormFieldValues.getClass().equals(Integer.class) ||
            includeFormFieldValues.getClass().equals(String.class) ||
            includeFormFieldValues.getClass().equals(java.net.URI.class)||
            includeFormFieldValues.getClass().isEnum()) {
            map.put("includeFormFieldValues", includeFormFieldValues);
        } else if (isListOfFile(includeFormFieldValues)) {
            for(int i = 0; i< getListSize(includeFormFieldValues); i++) {
                map.put("includeFormFieldValues", includeFormFieldValues);
            }
        }
        else {
          map.put("includeFormFieldValues", JSON.serialize(includeFormFieldValues));
        }
    }
    if (locale != null) {
  ...
  static {
    ...
    openapiFields.add("includeFormFieldValues");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmbeddedCloneTemplateJsonRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmbeddedCloneTemplateJsonRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmbeddedCloneTemplateJsonRequest is not found in the empty JSON string", EmbeddedCloneTemplateJsonRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmbeddedCloneTemplateJsonRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmbeddedCloneTemplateJsonRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmbeddedCloneTemplateJsonRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmbeddedCloneTemplateJsonRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EmbeddedCloneTemplateJsonRequest>() {
           @Override
           public void write(JsonWriter out, EmbeddedCloneTemplateJsonRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmbeddedCloneTemplateJsonRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmbeddedCloneTemplateJsonRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmbeddedCloneTemplateJsonRequest
   * @throws IOException if the JSON string is invalid with respect to EmbeddedCloneTemplateJsonRequest
   */
  public static EmbeddedCloneTemplateJsonRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmbeddedCloneTemplateJsonRequest.class);
  }

  /**
   * Convert an instance of EmbeddedCloneTemplateJsonRequest to an JSON string
   *
   * @return JSON string
   */
