...
public class IdVerificationSignerWebhookModel {
  ...
  public IdVerificationSignerWebhookModel() {
  }
  ...
  public boolean equals(Object o) {
    ...
    IdVerificationSignerWebhookModel idVerificationSignerWebhookModel = (IdVerificationSignerWebhookModel) o;
    return Objects.equals(this.type, idVerificationSignerWebhookModel.type) &&
        Objects.equals(this.maximumRetryCount, idVerificationSignerWebhookModel.maximumRetryCount) &&
        Objects.equals(this.status, idVerificationSignerWebhookModel.status) &&
        Objects.equals(this.nameMatcher, idVerificationSignerWebhookModel.nameMatcher) &&
        Objects.equals(this.requireLiveCapture, idVerificationSignerWebhookModel.requireLiveCapture) &&
        Objects.equals(this.requireMatchingSelfie, idVerificationSignerWebhookModel.requireMatchingSelfie) &&
        Objects.equals(this.holdForPrefill, idVerificationSignerWebhookModel.holdForPrefill) &&
        Objects.equals(this.prefillCompleted, idVerificationSignerWebhookModel.prefillCompleted) &&
        Objects.equals(this.allowedDocumentTypes, idVerificationSignerWebhookModel.allowedDocumentTypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, maximumRetryCount, status, nameMatcher, requireLiveCapture, requireMatchingSelfie, holdForPrefill, prefillCompleted, allowedDocumentTypes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IdVerificationSignerWebhookModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IdVerificationSignerWebhookModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IdVerificationSignerWebhookModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IdVerificationSignerWebhookModel is not found in the empty JSON string", IdVerificationSignerWebhookModel.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IdVerificationSignerWebhookModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IdVerificationSignerWebhookModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IdVerificationSignerWebhookModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IdVerificationSignerWebhookModel.class));

       return (TypeAdapter<T>) new TypeAdapter<IdVerificationSignerWebhookModel>() {
           @Override
           public void write(JsonWriter out, IdVerificationSignerWebhookModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IdVerificationSignerWebhookModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IdVerificationSignerWebhookModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IdVerificationSignerWebhookModel
   * @throws IOException if the JSON string is invalid with respect to IdVerificationSignerWebhookModel
   */
  public static IdVerificationSignerWebhookModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IdVerificationSignerWebhookModel.class);
  }

  /**
   * Convert an instance of IdVerificationSignerWebhookModel to an JSON string
   *
   * @return JSON string
   */
