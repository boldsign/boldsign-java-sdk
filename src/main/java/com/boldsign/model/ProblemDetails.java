...
public class ProblemDetails {
  ...
  public Map<String, Object> createFormData() throws ApiException {
    ...
    if (detail != null) {
        if (isFileTypeOrListOfFiles(detail)) {
            fileTypeFound = true;
        }

        if (detail.getClass().equals(java.io.File.class) ||
            detail.getClass().equals(Integer.class) ||
            detail.getClass().equals(String.class) ||
            detail.getClass().isEnum()) {
            map.put("detail", detail);
        } else if (isListOfFile(detail)) {
            for(int i = 0; i< getListSize(detail); i++) {
                map.put("detail", detail);
            }
        }
        else {
    ...
    if (instance != null) {
        if (isFileTypeOrListOfFiles(instance)) {
            fileTypeFound = true;
        }

        if (instance.getClass().equals(java.io.File.class) ||
            instance.getClass().equals(Integer.class) ||
            instance.getClass().equals(String.class) ||
            instance.getClass().isEnum()) {
            map.put("instance", instance);
        } else if (isListOfFile(instance)) {
            for(int i = 0; i< getListSize(instance); i++) {
                map.put("instance", instance);
            }
        }
        else {
