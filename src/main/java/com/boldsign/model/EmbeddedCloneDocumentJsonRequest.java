...
public class EmbeddedCloneDocumentJsonRequest {
  ...
  public EmbeddedCloneDocumentJsonRequest() {
  }

  public EmbeddedCloneDocumentJsonRequest redirectUrl(URI redirectUrl) {
  ...
  public EmbeddedCloneDocumentJsonRequest viewOption(ViewOptionEnum viewOption) {
  ...
  public EmbeddedCloneDocumentJsonRequest showSaveButton(Boolean showSaveButton) {
  ...
  public EmbeddedCloneDocumentJsonRequest showPreviewButton(Boolean showPreviewButton) {
  ...
  public EmbeddedCloneDocumentJsonRequest showNavigationButtons(Boolean showNavigationButtons) {
  ...
  public EmbeddedCloneDocumentJsonRequest linkValidTill(OffsetDateTime linkValidTill) {
  ...
  public EmbeddedCloneDocumentJsonRequest includeFormFieldValues(Boolean includeFormFieldValues) {
  ...
  public EmbeddedCloneDocumentJsonRequest locale(LocaleEnum locale) {
    this.locale = locale;
    return this;
  }
  ...
  public EmbeddedCloneDocumentJsonRequest showSendButton(Boolean showSendButton) {
  ...
  public EmbeddedCloneDocumentJsonRequest showToolbar(Boolean showToolbar) {
  ...
  public EmbeddedCloneDocumentJsonRequest showTooltip(Boolean showTooltip) {
  ...
  public EmbeddedCloneDocumentJsonRequest onBehalfOf(String onBehalfOf) {
  ...
  public boolean equals(Object o) {
    ...
    EmbeddedCloneDocumentJsonRequest embeddedCloneDocumentJsonRequest = (EmbeddedCloneDocumentJsonRequest) o;
    return Objects.equals(this.redirectUrl, embeddedCloneDocumentJsonRequest.redirectUrl) &&
        Objects.equals(this.viewOption, embeddedCloneDocumentJsonRequest.viewOption) &&
        Objects.equals(this.showSaveButton, embeddedCloneDocumentJsonRequest.showSaveButton) &&
        Objects.equals(this.showPreviewButton, embeddedCloneDocumentJsonRequest.showPreviewButton) &&
        Objects.equals(this.showNavigationButtons, embeddedCloneDocumentJsonRequest.showNavigationButtons) &&
        Objects.equals(this.linkValidTill, embeddedCloneDocumentJsonRequest.linkValidTill) &&
        Objects.equals(this.includeFormFieldValues, embeddedCloneDocumentJsonRequest.includeFormFieldValues) &&
        Objects.equals(this.locale, embeddedCloneDocumentJsonRequest.locale) &&
        Objects.equals(this.showSendButton, embeddedCloneDocumentJsonRequest.showSendButton) &&
        Objects.equals(this.showToolbar, embeddedCloneDocumentJsonRequest.showToolbar) &&
        Objects.equals(this.showTooltip, embeddedCloneDocumentJsonRequest.showTooltip) &&
        Objects.equals(this.onBehalfOf, embeddedCloneDocumentJsonRequest.onBehalfOf);
  }

  @Override
  public int hashCode() {
    return Objects.hash(redirectUrl, viewOption, showSaveButton, showPreviewButton, showNavigationButtons, linkValidTill, includeFormFieldValues, locale, showSendButton, showToolbar, showTooltip, onBehalfOf);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmbeddedCloneDocumentJsonRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmbeddedCloneDocumentJsonRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmbeddedCloneDocumentJsonRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmbeddedCloneDocumentJsonRequest is not found in the empty JSON string", EmbeddedCloneDocumentJsonRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmbeddedCloneDocumentJsonRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmbeddedCloneDocumentJsonRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmbeddedCloneDocumentJsonRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmbeddedCloneDocumentJsonRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EmbeddedCloneDocumentJsonRequest>() {
           @Override
           public void write(JsonWriter out, EmbeddedCloneDocumentJsonRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmbeddedCloneDocumentJsonRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmbeddedCloneDocumentJsonRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmbeddedCloneDocumentJsonRequest
   * @throws IOException if the JSON string is invalid with respect to EmbeddedCloneDocumentJsonRequest
   */
  public static EmbeddedCloneDocumentJsonRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmbeddedCloneDocumentJsonRequest.class);
  }

  /**
   * Convert an instance of EmbeddedCloneDocumentJsonRequest to an JSON string
   *
   * @return JSON string
   */
