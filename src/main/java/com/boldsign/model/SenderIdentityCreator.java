...
public class SenderIdentityCreator {
  ...
  public boolean equals(Object o) {
    ...
    SenderIdentityCreator senderIdentityCreator = (SenderIdentityCreator) o;
    return Objects.equals(this.name, senderIdentityCreator.name) &&
        Objects.equals(this.emailAddress, senderIdentityCreator.emailAddress) &&
        Objects.equals(this.userId, senderIdentityCreator.userId) &&
        Objects.equals(this.teamId, senderIdentityCreator.teamId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, emailAddress, userId, teamId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SenderIdentityCreator {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SenderIdentityCreator
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SenderIdentityCreator.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SenderIdentityCreator is not found in the empty JSON string", SenderIdentityCreator.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SenderIdentityCreator.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SenderIdentityCreator' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SenderIdentityCreator> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SenderIdentityCreator.class));

       return (TypeAdapter<T>) new TypeAdapter<SenderIdentityCreator>() {
           @Override
           public void write(JsonWriter out, SenderIdentityCreator value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SenderIdentityCreator read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SenderIdentityCreator given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SenderIdentityCreator
   * @throws IOException if the JSON string is invalid with respect to SenderIdentityCreator
   */
  public static SenderIdentityCreator fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SenderIdentityCreator.class);
  }

  /**
   * Convert an instance of SenderIdentityCreator to an JSON string
   *
   * @return JSON string
   */
