...
public class GroupContact {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.groupName, groupContact.groupName) &&
        Objects.equals(this.groupId, groupContact.groupId) &&
        Objects.equals(this.contacts, groupContact.contacts) &&
        Objects.equals(this.directories, groupContact.directories);
  }

  @Override
  public int hashCode() {
    return Objects.hash(groupName, groupId, contacts, directories);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GroupContact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GroupContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupContact is not found in the empty JSON string", GroupContact.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupContact.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupContact>() {
           @Override
           public void write(JsonWriter out, GroupContact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GroupContact read(JsonReader in) throws IOException {
   ...
   * @return An instance of GroupContact
   * @throws IOException if the JSON string is invalid with respect to GroupContact
   */
  public static GroupContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupContact.class);
  }
