...
public class DocumentSender {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, documentSender.name) &&
        Objects.equals(this.emailAddress, documentSender.emailAddress) &&
        Objects.equals(this.userId, documentSender.userId) &&
        Objects.equals(this.teamId, documentSender.teamId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentSender
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentSender.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentSender is not found in the empty JSON string", DocumentSender.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentSender.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentSender' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentSender> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentSender.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentSender>() {
           @Override
           public void write(JsonWriter out, DocumentSender value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DocumentSender read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentSender given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentSender
   * @throws IOException if the JSON string is invalid with respect to DocumentSender
   */
  public static DocumentSender fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentSender.class);
  }

  /**
   * Convert an instance of DocumentSender to an JSON string
   *
   * @return JSON string
   */
