...
public class TemplateTeamShare {
  ...
  public TemplateTeamShare() {
  }

  public TemplateTeamShare teamId(String teamId) {
    this.teamId = teamId;
    return this;
  }
  ...
  public TemplateTeamShare accessType(AccessTypeEnum accessType) {
  ...
  public boolean equals(Object o) {
    ...
    TemplateTeamShare templateTeamShare = (TemplateTeamShare) o;
    return Objects.equals(this.teamId, templateTeamShare.teamId) &&
        Objects.equals(this.accessType, templateTeamShare.accessType);
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateTeamShare {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateTeamShare
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateTeamShare.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateTeamShare is not found in the empty JSON string", TemplateTeamShare.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateTeamShare.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateTeamShare' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateTeamShare> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateTeamShare.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateTeamShare>() {
           @Override
           public void write(JsonWriter out, TemplateTeamShare value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateTeamShare read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateTeamShare given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateTeamShare
   * @throws IOException if the JSON string is invalid with respect to TemplateTeamShare
   */
  public static TemplateTeamShare fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateTeamShare.class);
  }

  /**
   * Convert an instance of TemplateTeamShare to an JSON string
   *
   * @return JSON string
   */
