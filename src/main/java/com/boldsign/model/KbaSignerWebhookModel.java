...
public class KbaSignerWebhookModel {
  ...
  public KbaSignerWebhookModel() {
  }

  public KbaSignerWebhookModel type(String type) {
    this.type = type;
    return this;
  }
  ...
  public KbaSignerWebhookModel maximumRetryCount(Integer maximumRetryCount) {
  ...
  public KbaSignerWebhookModel nameMatcher(String nameMatcher) {
  ...
  public KbaSignerWebhookModel status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    KbaSignerWebhookModel kbaSignerWebhookModel = (KbaSignerWebhookModel) o;
    return Objects.equals(this.type, kbaSignerWebhookModel.type) &&
        Objects.equals(this.maximumRetryCount, kbaSignerWebhookModel.maximumRetryCount) &&
        Objects.equals(this.nameMatcher, kbaSignerWebhookModel.nameMatcher) &&
        Objects.equals(this.status, kbaSignerWebhookModel.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class KbaSignerWebhookModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KbaSignerWebhookModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KbaSignerWebhookModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KbaSignerWebhookModel is not found in the empty JSON string", KbaSignerWebhookModel.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KbaSignerWebhookModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KbaSignerWebhookModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KbaSignerWebhookModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KbaSignerWebhookModel.class));

       return (TypeAdapter<T>) new TypeAdapter<KbaSignerWebhookModel>() {
           @Override
           public void write(JsonWriter out, KbaSignerWebhookModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KbaSignerWebhookModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KbaSignerWebhookModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KbaSignerWebhookModel
   * @throws IOException if the JSON string is invalid with respect to KbaSignerWebhookModel
   */
  public static KbaSignerWebhookModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KbaSignerWebhookModel.class);
  }

  /**
   * Convert an instance of KbaSignerWebhookModel to an JSON string
   *
   * @return JSON string
   */
