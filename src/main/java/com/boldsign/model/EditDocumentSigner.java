...
public class EditDocumentSigner {
  ...
  private List<EditFormField> formFields;
  ...
  public EditDocumentSigner() {
  }

  public EditDocumentSigner editAction(EditActionEnum editAction) {
  ...
  public EditDocumentSigner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public EditDocumentSigner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public EditDocumentSigner emailAddress(String emailAddress) {
  ...
  public EditDocumentSigner privateMessage(String privateMessage) {
  ...
  public EditDocumentSigner authenticationType(AuthenticationTypeEnum authenticationType) {
  ...
  public EditDocumentSigner phoneNumber(PhoneNumber phoneNumber) {
  ...
  public EditDocumentSigner deliveryMode(DeliveryModeEnum deliveryMode) {
  ...
  public EditDocumentSigner authenticationCode(String authenticationCode) {
  ...
  public EditDocumentSigner identityVerificationSettings(IdentityVerificationSettings identityVerificationSettings) {
  ...
  public EditDocumentSigner enableEmailOTP(Boolean enableEmailOTP) {
  ...
  public EditDocumentSigner signerType(SignerTypeEnum signerType) {
  ...
  public EditDocumentSigner hostEmail(String hostEmail) {
  ...
  public EditDocumentSigner signerRole(String signerRole) {
  ...
  public EditDocumentSigner allowFieldConfiguration(Boolean allowFieldConfiguration) {
  ...
  public EditDocumentSigner formFields(List<EditFormField> formFields) {
    this.formFields = formFields;
    return this;
  }

  public EditDocumentSigner addFormFieldsItem(EditFormField formFieldsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<EditFormField> getFormFields() {
    return formFields;
  }

  public void setFormFields(List<EditFormField> formFields) {
    this.formFields = formFields;
  }


  public EditDocumentSigner language(LanguageEnum language) {
  ...
  public EditDocumentSigner locale(LocaleEnum locale) {
    this.locale = locale;
    return this;
  }
  ...
  public EditDocumentSigner signType(SignTypeEnum signType) {
  ...
  public EditDocumentSigner groupId(String groupId) {
  ...
  public EditDocumentSigner recipientNotificationSettings(RecipientNotificationSettings recipientNotificationSettings) {
  ...
  public EditDocumentSigner authenticationRetryCount(Integer authenticationRetryCount) {
  ...
  public EditDocumentSigner enableQes(Boolean enableQes) {
  ...
  public EditDocumentSigner authenticationSettings(AuthenticationSettings authenticationSettings) {
  ...
  public boolean equals(Object o) {
    ...
    EditDocumentSigner editDocumentSigner = (EditDocumentSigner) o;
    return Objects.equals(this.editAction, editDocumentSigner.editAction) &&
        Objects.equals(this.id, editDocumentSigner.id) &&
        Objects.equals(this.name, editDocumentSigner.name) &&
        Objects.equals(this.emailAddress, editDocumentSigner.emailAddress) &&
        Objects.equals(this.privateMessage, editDocumentSigner.privateMessage) &&
        Objects.equals(this.authenticationType, editDocumentSigner.authenticationType) &&
        Objects.equals(this.phoneNumber, editDocumentSigner.phoneNumber) &&
        ...
        Objects.equals(this.hostEmail, editDocumentSigner.hostEmail) &&
        Objects.equals(this.signerRole, editDocumentSigner.signerRole) &&
        Objects.equals(this.allowFieldConfiguration, editDocumentSigner.allowFieldConfiguration) &&
        Objects.equals(this.formFields, editDocumentSigner.formFields) &&
        Objects.equals(this.language, editDocumentSigner.language) &&
        Objects.equals(this.locale, editDocumentSigner.locale) &&
        Objects.equals(this.signType, editDocumentSigner.signType) &&
        Objects.equals(this.groupId, editDocumentSigner.groupId) &&
        Objects.equals(this.recipientNotificationSettings, editDocumentSigner.recipientNotificationSettings) &&
        Objects.equals(this.authenticationRetryCount, editDocumentSigner.authenticationRetryCount) &&
        Objects.equals(this.enableQes, editDocumentSigner.enableQes) &&
        Objects.equals(this.authenticationSettings, editDocumentSigner.authenticationSettings);
  }
  ...
  public String toString() {
    ...
    sb.append("class EditDocumentSigner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EditDocumentSigner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EditDocumentSigner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EditDocumentSigner is not found in the empty JSON string", EditDocumentSigner.openapiRequiredFields.toString()));
        }
      }
	  //Ignored additional properties from response json. 

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EditDocumentSigner.openapiRequiredFields) {
      ...
      if (jsonObj.get("formFields") != null && !jsonObj.get("formFields").isJsonNull()) {
        ...
        if (jsonArrayformFields != null) {
          ...
          for (int i = 0; i < jsonArrayformFields.size(); i++) {
            EditFormField.validateJsonElement(jsonArrayformFields.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EditDocumentSigner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EditDocumentSigner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EditDocumentSigner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EditDocumentSigner.class));

       return (TypeAdapter<T>) new TypeAdapter<EditDocumentSigner>() {
           @Override
           public void write(JsonWriter out, EditDocumentSigner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EditDocumentSigner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EditDocumentSigner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EditDocumentSigner
   * @throws IOException if the JSON string is invalid with respect to EditDocumentSigner
   */
  public static EditDocumentSigner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EditDocumentSigner.class);
  }

  /**
   * Convert an instance of EditDocumentSigner to an JSON string
   *
   * @return JSON string
   */
