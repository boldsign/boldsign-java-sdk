...
public class ContactsList {
  ...
  private List<ContactsDetails> result;

  public ContactsList() {
  }

  public ContactsList pageDetails(ContactPageDetails pageDetails) {
  ...
  public ContactsList result(List<ContactsDetails> result) {
    this.result = result;
    return this;
  }

  public ContactsList addResultItem(ContactsDetails resultItem) {
    if (this.result == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ContactsDetails> getResult() {
    return result;
  }

  public void setResult(List<ContactsDetails> result) {
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pageDetails, contactsList.pageDetails) &&
        Objects.equals(this.result, contactsList.result);
  }
  ...
  public Map<String, Object> createFormData() throws ApiException {
    ...
    if(!fileTypeFound) {
        Field[] fields = ContactsList.class.getDeclaredFields();
      ...
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        ...
        if (jsonArrayresult != null) {
          ...
          for (int i = 0; i < jsonArrayresult.size(); i++) {
            ContactsDetails.validateJsonElement(jsonArrayresult.get(i));
          };
        }
      }
  }
