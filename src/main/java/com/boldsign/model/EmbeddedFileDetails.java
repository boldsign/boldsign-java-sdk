...
public class EmbeddedFileDetails {
  ...
  public EmbeddedFileDetails emailId(String emailId) {
  ...
  public EmbeddedFileDetails countryCode(String countryCode) {
  ...
  public EmbeddedFileDetails phoneNumber(String phoneNumber) {
  ...
  public EmbeddedFileDetails redirectUrl(String redirectUrl) {
  ...
  public EmbeddedFileDetails order(Integer order) {
    this.order = order;
    return this;
  }
  ...
  public EmbeddedFileDetails onBehalfOf(String onBehalfOf) {
  ...
  public boolean equals(Object o) {
    ...
    EmbeddedFileDetails embeddedFileDetails = (EmbeddedFileDetails) o;
    return Objects.equals(this.emailId, embeddedFileDetails.emailId) &&
        Objects.equals(this.countryCode, embeddedFileDetails.countryCode) &&
        Objects.equals(this.phoneNumber, embeddedFileDetails.phoneNumber) &&
        Objects.equals(this.redirectUrl, embeddedFileDetails.redirectUrl) &&
        Objects.equals(this.order, embeddedFileDetails.order) &&
        Objects.equals(this.onBehalfOf, embeddedFileDetails.onBehalfOf);
  }

  @Override
  public int hashCode() {
    return Objects.hash(emailId, countryCode, phoneNumber, redirectUrl, order, onBehalfOf);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmbeddedFileDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmbeddedFileDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmbeddedFileDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmbeddedFileDetails is not found in the empty JSON string", EmbeddedFileDetails.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmbeddedFileDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmbeddedFileDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmbeddedFileDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmbeddedFileDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<EmbeddedFileDetails>() {
           @Override
           public void write(JsonWriter out, EmbeddedFileDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmbeddedFileDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmbeddedFileDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmbeddedFileDetails
   * @throws IOException if the JSON string is invalid with respect to EmbeddedFileDetails
   */
  public static EmbeddedFileDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmbeddedFileDetails.class);
  }

  /**
   * Convert an instance of EmbeddedFileDetails to an JSON string
   *
   * @return JSON string
   */
