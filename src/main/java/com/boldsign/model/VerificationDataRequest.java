...
public class VerificationDataRequest {
  ...
  public boolean equals(Object o) {
    ...
    VerificationDataRequest verificationDataRequest = (VerificationDataRequest) o;
    return Objects.equals(this.emailId, verificationDataRequest.emailId) &&
        Objects.equals(this.countryCode, verificationDataRequest.countryCode) &&
        Objects.equals(this.phoneNumber, verificationDataRequest.phoneNumber) &&
        Objects.equals(this.order, verificationDataRequest.order) &&
        Objects.equals(this.onBehalfOf, verificationDataRequest.onBehalfOf);
  }

  @Override
  public int hashCode() {
    return Objects.hash(emailId, countryCode, phoneNumber, order, onBehalfOf);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VerificationDataRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VerificationDataRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VerificationDataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VerificationDataRequest is not found in the empty JSON string", VerificationDataRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VerificationDataRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VerificationDataRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VerificationDataRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VerificationDataRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VerificationDataRequest>() {
           @Override
           public void write(JsonWriter out, VerificationDataRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VerificationDataRequest read(JsonReader in) throws IOException {
   ...
   * @return An instance of VerificationDataRequest
   * @throws IOException if the JSON string is invalid with respect to VerificationDataRequest
   */
  public static VerificationDataRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VerificationDataRequest.class);
  }
