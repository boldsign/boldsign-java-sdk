...
public class DocumentApi {
     ...
     */
    public okhttp3.Call cancelEditingCall(String documentId, String onBehalfOf, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v1/document/cancelEditing";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call cancelEditingValidateBeforeCall(String documentId, String onBehalfOf, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'documentId' is set
        if (documentId == null) {
            throw new ApiException("Missing the required parameter 'documentId' when calling cancelEditing(Async)");
        }

        return cancelEditingCall(documentId, onBehalfOf, _callback);
     ...
     */
    public void cancelEditing(String documentId, String onBehalfOf) throws ApiException {
        cancelEditingWithHttpInfo(documentId, onBehalfOf);
    }
     ...
     */
    public ApiResponse<Void> cancelEditingWithHttpInfo(String documentId, String onBehalfOf) throws ApiException {
        okhttp3.Call localVarCall = cancelEditingValidateBeforeCall(documentId, onBehalfOf, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call cancelEditingAsync(String documentId, String onBehalfOf, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = cancelEditingValidateBeforeCall(documentId, onBehalfOf, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
