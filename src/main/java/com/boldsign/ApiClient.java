...
import com.boldsign.auth.Authentication;
import com.boldsign.auth.HttpBasicAuth;
import com.boldsign.auth.HttpBearerAuth;
import com.boldsign.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.boldsign.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.0.0-beta.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.boldsign.com
     ...
     * @return a {@link com.boldsign.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.boldsign.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.boldsign.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.boldsign.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.boldsign.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.boldsign.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.boldsign.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.boldsign.ApiException If fails to update the parameters
     */
     ...
     * @throws com.boldsign.ApiException If fail to serialize the request body object into a string
     */
