...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.AuthenticationSettings.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.Base64File.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.CreateGroupContactResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.Creators.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.Date.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.EmbeddedDocumentEdited.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.EmbeddedDocumentRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.EmbeddedFileDetails.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.EmbeddedFileLink.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.EmbeddedMergeTemplateFormRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.EmbeddedTemplatePreview.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.EmbeddedTemplatePreviewJsonRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.Error.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.ErrorResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.TemplateTeamShareRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.UpdateGroupContact.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.UpdateUser.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.boldsign.model.UpdateUserMetaData.CustomTypeAdapterFactory());
