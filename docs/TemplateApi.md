...
<a id="shareTemplate"></a>
# **shareTemplate**
> shareTemplate(templateId, templateShareRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.shareTemplate(templateId, templateShareRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling TemplateApi#shareTemplate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
